...
@NamedQueries({
    ...
    , @NamedQuery(name = "Movimientos.pasivosCorrientesPOSI", query = "SELECT SUM(m.monto) FROM Movimientos m JOIN m.idCuenta c WHERE c.idCuenta LIKE '21%' AND c.tipoSaldo='H' AND m.fecha BETWEEN '2017-11-1' AND '2017-11-30' ORDER BY m.fecha ASC")  
    , @NamedQuery(name = "Movimientos.pasivosCorrientesNEG", query = "SELECT SUM(m.monto) FROM Movimientos m JOIN m.idCuenta c WHERE c.idCuenta LIKE '21%' AND c.tipoSaldo='D' AND m.fecha BETWEEN '2017-11-1' AND '2017-11-30' ORDER BY m.fecha ASC")
    , @NamedQuery(name = "Movimientos.pasivosNOCorrientesPOSI", query = "SELECT SUM(m.monto) FROM Movimientos m JOIN m.idCuenta c WHERE c.idCuenta LIKE '22%' AND c.tipoSaldo='H' AND m.fecha BETWEEN '2017-11-1' AND '2017-11-30' ORDER BY m.fecha ASC")  
    , @NamedQuery(name = "Movimientos.pasivosNOCorrientesNEG", query = "SELECT SUM(m.monto) FROM Movimientos m JOIN m.idCuenta c WHERE c.idCuenta LIKE '22%' AND c.tipoSaldo='D' AND m.fecha BETWEEN '2017-11-1' AND '2017-11-30' ORDER BY m.fecha ASC")
